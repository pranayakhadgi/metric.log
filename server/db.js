...
try {
    ...
    db.exec(`
        CREATE TABLE IF NOT EXISTS weekly_reports (
            ...
            kits_assembled INTEGER DEFAULT 0 CHECK (kits_assembled >= 0),
            funds_raised REAL DEFAULT 0 CHECK (funds_raised >= 0),
            volunteer_hours REAL DEFAULT 0 CHECK (volunteer_hours >= 0),
            team TEXT,
            notes TEXT,
